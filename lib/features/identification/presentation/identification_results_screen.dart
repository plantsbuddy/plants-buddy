        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              if (state.identificationResults.isNotEmpty)
              ...
              if (state.identificationResults.isEmpty)
                Column(
                  children: [
                    Image.asset(
                      custom_icons.identificationFailed,
                      height: 45,
                    ),
                    SizedBox(height: 15),
                    Text(
                    ...
                    SizedBox(height: 10),
                    Text(
                      'The provided image could not be identified by the app, try seeking help in community',
