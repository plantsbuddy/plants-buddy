...
class MyPostPopup extends StatelessWidget {
  const MyPostPopup(this._post, {Key? key}) : super(key: key);
            ...
            builder: (_) {
              return AlertDialog(
                ...
                actions: [
                  ...
                  TextButton(
                    onPressed: () {
                      context.read<CommunityBloc>().add(CommunityDeletePostPressed(_post.id!));
