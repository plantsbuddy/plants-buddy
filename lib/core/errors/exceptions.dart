...
class EmptyPostTitleException implements Exception {}

class EmptyPostDescriptionException implements Exception {}

class EmptyCommunitySearchTermException implements Exception {}

class ReminderDateNotSelectedException implements Exception {}
